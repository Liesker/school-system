<x-layout>
	<div class="max-w-lg w-full mx-auto bg-white rounded-xl shadow-2xl p-8 mt-8">
		<h1 class="mb-6 text-2xl font-extrabold text-gray-800 text-center tracking-tight">Add Presence</h1>
		<form action="{{ route('presence.store') }}" method="POST" class="space-y-6">
			...
			<div class="flex gap-3 justify-end pt-4">
				...
				<a href="{{ route('presence.index') }}" class="bg-gray-100 text-gray-700 px-4 py-2 rounded hover:bg-gray-200 font-semibold transition">Cancel</a>
			</div>
		</form>
	</div>
</x-layout>
